...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Subtema.slug'
        db.delete_column('multimedia_subtema', 'slug')


    def backwards(self, orm):
        
        # Adding field 'Subtema.slug'
        db.add_column('multimedia_subtema', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=50, unique=True, db_index=True), keep_default=False)
