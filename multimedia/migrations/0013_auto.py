...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field idioma on 'Video'
        db.create_table('multimedia_video_idioma', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('video', models.ForeignKey(orm['multimedia.video'], null=False)),
            ('idioma', models.ForeignKey(orm['multimedia.idioma'], null=False))
        ))
        db.create_unique('multimedia_video_idioma', ['video_id', 'idioma_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field idioma on 'Video'
        db.delete_table('multimedia_video_idioma')
