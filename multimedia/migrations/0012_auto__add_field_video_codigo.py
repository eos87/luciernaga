...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.codigo'
        db.add_column('multimedia_video', 'codigo', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Video.codigo'
        db.delete_column('multimedia_video', 'codigo')
