...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tema.logo'
        db.add_column('multimedia_tema', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Changing field 'Tema.imagen'
        db.alter_column('multimedia_tema', 'imagen', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True))


    def backwards(self, orm):
        
        # Deleting field 'Tema.logo'
        db.delete_column('multimedia_tema', 'logo')

        # Changing field 'Tema.imagen'
        db.alter_column('multimedia_tema', 'imagen', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
