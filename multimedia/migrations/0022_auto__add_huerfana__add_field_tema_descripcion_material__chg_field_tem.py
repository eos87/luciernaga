...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Huerfana'
        db.create_table('multimedia_huerfana', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('archivo', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal('multimedia', ['Huerfana'])

        # Adding field 'Tema.descripcion_material'
        db.add_column('multimedia_tema', 'descripcion_material', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
        ...
        # Changing field 'Video.codigo'
        db.alter_column('multimedia_video', 'codigo', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Deleting model 'Huerfana'
        db.delete_table('multimedia_huerfana')

        # Deleting field 'Tema.descripcion_material'
        db.delete_column('multimedia_tema', 'descripcion_material')
        ...
        # Changing field 'Video.codigo'
        db.alter_column('multimedia_video', 'codigo', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True))
