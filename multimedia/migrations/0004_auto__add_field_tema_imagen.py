...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tema.imagen'
        db.add_column('multimedia_tema', 'imagen', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tema.imagen'
        db.delete_column('multimedia_tema', 'imagen')
