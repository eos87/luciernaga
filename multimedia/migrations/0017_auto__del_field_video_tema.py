...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Video.tema'
        db.delete_column('multimedia_video', 'tema_id')


    def backwards(self, orm):
        
        # Adding field 'Video.tema'
        db.add_column('multimedia_video', 'tema', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['multimedia.Tema'], blank=True), keep_default=False)
