...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field tema2 on 'Video'
        db.delete_table('multimedia_video_tema2')

        # Adding M2M table for field tema on 'Video'
        db.create_table('multimedia_video_tema', (
        ...
        db.create_unique('multimedia_video_tema', ['video_id', 'tema_id'])

        # Changing field 'Subtema.tema'
        db.alter_column('multimedia_subtema', 'tema_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['multimedia.Tema'], blank=True))


    def backwards(self, orm):
        
        # Adding M2M table for field tema2 on 'Video'
        db.create_table('multimedia_video_tema2', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('video', models.ForeignKey(orm['multimedia.video'], null=False)),
            ('tema', models.ForeignKey(orm['multimedia.tema'], null=False))
        ))
        db.create_unique('multimedia_video_tema2', ['video_id', 'tema_id'])

        # Removing M2M table for field tema on 'Video'
        db.delete_table('multimedia_video_tema')

        # Changing field 'Subtema.tema'
        db.alter_column('multimedia_subtema', 'tema_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['multimedia.Tema']))
