...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Video.archivo'
        db.alter_column('multimedia_video', 'archivo', self.gf('django.db.models.fields.CharField')(max_length=300))


    def backwards(self, orm):
        
        # Changing field 'Video.archivo'
        db.alter_column('multimedia_video', 'archivo', self.gf('django.db.models.fields.files.FileField')(max_length=100))
