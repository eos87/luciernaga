...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('multimedia_video', 'slug')


    def backwards(self, orm):
        
        # Adding field 'Video.slug'
        db.add_column('multimedia_video', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=50, unique=True, db_index=True), keep_default=False)
