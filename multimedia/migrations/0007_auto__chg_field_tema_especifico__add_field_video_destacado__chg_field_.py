...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.destacado'
        db.add_column('multimedia_video', 'destacado', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Changing field 'Video.portada'
        db.alter_column('multimedia_video', 'portada', self.gf('luciernaga.thumbs.ImageWithThumbsField')(max_length=100))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Video.destacado'
        db.delete_column('multimedia_video', 'destacado')

        # Changing field 'Video.portada'
        db.alter_column('multimedia_video', 'portada', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
