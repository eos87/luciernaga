...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Evento.titulo_galeria'
        db.add_column('eventos_evento', 'titulo_galeria', self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True), keep_default=False)

        # Adding field 'Evento.fecha_galeria'
        db.add_column('eventos_evento', 'fecha_galeria', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 2, 10, 21, 0, 6, 721785), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Evento.titulo_galeria'
        db.delete_column('eventos_evento', 'titulo_galeria')

        # Deleting field 'Evento.fecha_galeria'
        db.delete_column('eventos_evento', 'fecha_galeria')
    ...
    models = {
        ...
        'eventos.evento': {
            ...
            'fecha_galeria': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 10, 21, 0, 6, 721785)', 'blank': 'True'}),
        ...
        'material.documento': {
            ...
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 10, 21, 0, 6, 717557)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'portada': ('luciernaga.thumbs.ImageWithThumbsField', [], {'max_length': '100'}),
