...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('eventos_noticia', (
        ...
        db.send_create_signal('eventos', ['Noticia'])


    def backwards(self, orm):
        
        # Deleting model 'Noticia'
        db.delete_table('eventos_noticia')
    ...
    models = {
        ...
        'material.documento': {
            ...
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 15, 22, 10, 21, 277919)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'portada': ('luciernaga.thumbs.ImageWithThumbsField', [], {'max_length': '100'}),
