...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('eventos_evento_documentos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('evento', models.ForeignKey(orm['eventos.evento'], null=False)),
            ('documento', models.ForeignKey(orm['material.documento'], null=False))
        ))
        db.create_unique('eventos_evento_documentos', ['evento_id', 'documento_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field documentos on 'Evento'
        db.delete_table('eventos_evento_documentos')
    ...
    models = {
        ...
        'material.documento': {
            ...
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 15, 21, 53, 22, 61970)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'portada': ('luciernaga.thumbs.ImageWithThumbsField', [], {'max_length': '100'}),
