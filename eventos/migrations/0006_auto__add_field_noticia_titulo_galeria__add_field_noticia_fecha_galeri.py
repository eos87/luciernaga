...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Noticia.titulo_galeria'
        db.add_column('eventos_noticia', 'titulo_galeria', self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True), keep_default=False)

        # Adding field 'Noticia.fecha_galeria'
        db.add_column('eventos_noticia', 'fecha_galeria', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 2, 10, 21, 30, 10, 425895), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Noticia.titulo_galeria'
        db.delete_column('eventos_noticia', 'titulo_galeria')

        # Deleting field 'Noticia.fecha_galeria'
        db.delete_column('eventos_noticia', 'fecha_galeria')
    ...
    models = {
        ...
        'eventos.evento': {
            ...
            'fecha_galeria': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 10, 21, 30, 10, 424047)', 'blank': 'True'}),
        ...
        'eventos.noticia': {
            ...
            'documentos': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['material.Documento']", 'null': 'True', 'blank': 'True'}),
            'fecha': ('django.db.models.fields.DateTimeField', [], {}),
            'fecha_galeria': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 10, 21, 30, 10, 425895)', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'portada': ('luciernaga.thumbs.ImageWithThumbsField', [], {'max_length': '100'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'db_index': 'True'}),
            'titulo': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
        ...
        'material.documento': {
            ...
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 10, 21, 30, 10, 419860)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'portada': ('luciernaga.thumbs.ImageWithThumbsField', [], {'max_length': '100'}),
