...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('material_documento', 'red', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    ...
    models = {
        ...
        'material.documento': {
            ...
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 15, 22, 36, 51, 602697)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
