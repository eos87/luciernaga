...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Documento.user'
        db.add_column('material_documento', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)

        # Changing field 'Documento.red'
        db.alter_column('material_documento', 'red', self.gf('django.db.models.fields.BooleanField')(blank=True))


    def backwards(self, orm):
        
        # Deleting field 'Documento.user'
        db.delete_column('material_documento', 'user_id')

        # Changing field 'Documento.red'
        db.alter_column('material_documento', 'red', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'material.documento': {
            ...
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 15, 22, 24, 4, 969547)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'portada': ('luciernaga.thumbs.ImageWithThumbsField', [], {'max_length': '100'}),
            'red': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
