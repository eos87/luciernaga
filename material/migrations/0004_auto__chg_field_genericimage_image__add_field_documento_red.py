...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GenericImage.image'
        db.alter_column('material_genericimage', 'image', self.gf('luciernaga.material.thumbs.ImageWithThumbsField')(max_length=100))

        # Adding field 'Documento.red'
        db.add_column('material_documento', 'red', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'GenericImage.image'
        db.alter_column('material_genericimage', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Deleting field 'Documento.red'
        db.delete_column('material_documento', 'red')
    ...
    models = {
        ...
        'material.documento': {
            ...
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 15, 16, 41, 41, 724119)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'portada': ('luciernaga.thumbs.ImageWithThumbsField', [], {'max_length': '100'}),
            'red': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'material.fotoportada': {
            'Meta': {'ordering': "['-id']", 'object_name': 'FotoPortada'},
