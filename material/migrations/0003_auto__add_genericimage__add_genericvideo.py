...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GenericImage'
        db.create_table('material_genericimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal('material', ['GenericImage'])

        # Adding model 'GenericVideo'
        db.create_table('material_genericvideo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
        ...
        db.send_create_signal('material', ['GenericVideo'])


    def backwards(self, orm):
        
        # Deleting model 'GenericImage'
        db.delete_table('material_genericimage')

        # Deleting model 'GenericVideo'
        db.delete_table('material_genericvideo')
    ...
    models = {
        ...
        'material.documento': {
            ...
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 10, 0, 25, 27, 141062)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
