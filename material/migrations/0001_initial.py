...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('material_documento', (
            ...
            ('fecha', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 1, 16, 0, 54, 17, 542966))),
            ('archivo', self.gf('luciernaga.multimedia.customfilefield.ContentTypeRestrictedFileField')(max_length=100)),
        ))
        db.send_create_signal('material', ['Documento'])

        # Adding M2M table for field tema on 'Documento'
        db.create_table('material_documento_tema', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('documento', models.ForeignKey(orm['material.documento'], null=False)),
            ('tema', models.ForeignKey(orm['multimedia.tema'], null=False))
        ))
        db.create_unique('material_documento_tema', ['documento_id', 'tema_id'])

        # Adding M2M table for field videos_relacionados on 'Documento'
        db.create_table('material_documento_videos_relacionados', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('documento', models.ForeignKey(orm['material.documento'], null=False)),
            ('video', models.ForeignKey(orm['multimedia.video'], null=False))
        ))
        db.create_unique('material_documento_videos_relacionados', ['documento_id', 'video_id'])


    def backwards(self, orm):
        
        # Deleting model 'Documento'
        db.delete_table('material_documento')

        # Removing M2M table for field tema on 'Documento'
        db.delete_table('material_documento_tema')

        # Removing M2M table for field videos_relacionados on 'Documento'
        db.delete_table('material_documento_videos_relacionados')
    ...
    models = {
        ...
        'material.documento': {
            ...
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 16, 0, 54, 17, 542966)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
