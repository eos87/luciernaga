...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Contenido.nombre'
        db.delete_column('red_contenido', 'nombre')

        # Adding field 'Contenido.titulo'
        db.add_column('red_contenido', 'titulo', self.gf('django.db.models.fields.CharField')(default='', max_length=150), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Contenido.nombre'
        db.add_column('red_contenido', 'nombre', self.gf('django.db.models.fields.CharField')(default='', max_length=150), keep_default=False)

        # Deleting field 'Contenido.titulo'
        db.delete_column('red_contenido', 'titulo')
