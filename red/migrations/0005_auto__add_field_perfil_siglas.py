...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Perfil.siglas'
        db.add_column('red_perfil', 'siglas', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Perfil.siglas'
        db.delete_column('red_perfil', 'siglas')
    ...
    models = {
        ...
        'red.perfil': {
            ...
            'siglas': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
